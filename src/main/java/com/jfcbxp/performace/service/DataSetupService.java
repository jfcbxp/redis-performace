...
public class DataSetupService implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //String query = StreamUtils.copyToString(resource.getInputStream(), StandardCharsets.UTF_8);
            String query = "DROP TABLE IF EXISTS product; CREATE TABLE product(id serial PRIMARY KEY,description VARCHAR (500),price numeric (10,2) NOT NULL);";
        ...
        this.entityTemplate.getDatabaseClient().sql(query)
                .then()
                .then(insert)
